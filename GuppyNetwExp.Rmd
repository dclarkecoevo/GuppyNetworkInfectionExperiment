...
ggplot(IndexContactsVRres, aes(x=InfectionTrt, y=visregRes, fill=InfectionTrt))+geom_boxplot(outliers=FALSE)+geom_jitter()+ylab("Contacts initiated by index")+xlab("Infection Treatment")+theme_classic()+theme(text=element_text(size=18))+theme(legend.position="none")
...
ggplot(IndexContactsRecVRres, aes(x=InfectionTrt, y=visregRes, fill=InfectionTrt))+geom_boxplot(outliers=FALSE)+geom_jitter()+ylab("Contacts recevied by index")+xlab("Infection Treatment")+theme_classic()+theme(text=element_text(size=18))+theme(legend.position="none")
...
InfCRlm<-glmmTMB(Infectionstat~Contactinit+Sex+(1|population),  IndividualInfDFD2, family=binomial())
...
ggplot(InfSxlmVRres, aes(x=Sex, visregRes))+geom_boxplot()+geom_jitter()+theme_classic()+theme(text=element_text(size=20))+xlab(" ")+ylab("Chance of infection on Day 3")
...
# #Visreg of contact rate effect
#
InfCRlmVR<-visreg(InfCRlm, "Contactinit", scale="response", partial=TRUE, plot=FALSE)

InfCRlmVRfit<-InfCRlmVR$fit
InfCRlmVRres<-InfCRlmVR$res


ggplot(InfCRlmVRfit, aes(x=Contactinit, visregFit))+geom_smooth(method="lm")+theme_classic()+geom_point(data=InfCRlmVRres, aes(x=Contactinit, visregRes))+xlab("Initiated contact rate")+ylab("Chance of infection on Day 3")+theme(text=element_text(size=22))
...
InfIWxSxvr<-visreg(InfbyIndexWlm, "IndexContact_init", "Sex", scale="response", rug=FALSE, gg=TRUE)+geom_point()+xlab("Initated contact with index rate")+ylab("Chance of being infected on Day 3")+theme_classic()+theme(text=element_text(size=18))
print(InfIWxSxvr)
